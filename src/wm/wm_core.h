...
internal void registry_global(void *data, struct wl_registry *wl_registry,
...
internal void registry_global_remove(void *data, struct wl_registry *registry,
                                     uint32_t name) {
  // Deliberately left blank
}

internal const struct wl_registry_listener registry_listener = {
    .global = registry_global,
    .global_remove = registry_global_remove,
};

internal B32 wm_init_globals(struct wm_globals *wm_globals) {
