...
internal String8 wm_get_clipboard_text(Arena *arena) { return str8_zero(); }
...
internal B32 wm_window_is_focused(WM_Window window) { return 0; }
...
internal B32 wm_window_is_maximized(WM_Window window) { return 0; }

internal void wm_window_set_maximized(WM_Window window, B32 maximized) {}

internal B32 wm_window_is_minimized(WM_Window window) { return 0; }
...
internal F32 wm_dpi_from_window(WM_Window window) { return 96.f; }
...
internal F32 wm_dpi_from_monitor(WM_Monitor monitor) { return 96.f; }
...
internal B32 wm_key_is_down(WM_Key key) { return 0; }

internal Vec2F32 wm_mouse_from_window(WM_Window window) { return v2f32(0, 0); }
