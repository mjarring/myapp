...
wm_string_from_event_kind(WM_EventKind kind)
{
  ...
  switch (kind)
  {
    ...
    break;
    case WM_EventKind_Press: {
      result = str8_lit("Press");
    }
    break;
    case WM_EventKind_Release: {
      result = str8_lit("Release");
    }
    break;
    case WM_EventKind_MouseMove: {
      result = str8_lit("MouseMove");
    }
    break;
    case WM_EventKind_Text: {
      result = str8_lit("Text");
    }
    break;
    case WM_EventKind_Scroll: {
      result = str8_lit("Scroll");
    }
    break;
    case WM_EventKind_WindowLoseFocus: {
      result = str8_lit("WindowLoseFocus");
    }
    break;
    case WM_EventKind_WindowClose: {
      result = str8_lit("WindowClose");
    }
    break;
    case WM_EventKind_FileDrop: {
      result = str8_lit("FileDrop");
    }
    break;
    case WM_EventKind_Wakeup: {
      result = str8_lit("Wakeup");
    }
    break;
  }
  return result;
...
wm_string_list_from_modifiers(Arena *arena, WM_Modifiers modifiers)
{
  ...
  {
    str8_list_push(arena, &result, str8_lit("Ctrl"));
  }
  if (modifiers & WM_Modifier_Shift)
  {
    str8_list_push(arena, &result, str8_lit("Shift"));
  }
  if (modifiers & WM_Modifier_Alt)
  {
    str8_list_push(arena, &result, str8_lit("Alt"));
  }
  return result;
}
